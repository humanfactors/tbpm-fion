...
func processFile(file string) (subj *Participant, err error) {
	// Open and Process a single file, return a subject
	// Open file
...
/*	Takes a single output line and a pointer to Trial
	Calls functions to update point to Trial
*/
...
func GetMeasureType(line string) (measuretype string, err error) {
	/*
		Searches line for variable in measure vartpes. Returns type if found.
	*/
